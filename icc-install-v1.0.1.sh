...
if [ $version = "16.04" ]; then
    ...
    unzip -o icc-ubuntu16.04-v1.0.1.zip    
else
    ...
    unzip -o icc-ubuntu18.04-v1.0.1.zip
fi
...
echo -e "addnode=13.232.197.235" >> /root/.icc/icc.conf
echo -e "addnode=13.233.91.39" >> /root/.icc/icc.conf
echo -e "addnode=13.232.111.77" >> /root/.icc/icc.conf
echo -e "addnode=13.232.105.253" >> /root/.icc/icc.conf
